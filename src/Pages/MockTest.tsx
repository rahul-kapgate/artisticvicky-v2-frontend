...
export default function MockTest() {
  ...
  if (!testStarted) {
    return (
      <div
        className={`min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#0f1b3d] via-[#152a52] to-[#1a237e] text-gray-100 px-4 py-10 relative transition-all duration-300 ${
          confirmOpen ? "backdrop-blur-sm" : ""
        }`}
      >
        {/* 🔙 Back Button */}
        <button
        ...
        <div className="max-w-2xl w-full bg-[#0f1b3d]/70 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-lg mt-12 sm:mt-20 text-center">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-gray-300">Loading mock test questions...</p>
            </div>
          ) : fetchError ? (
